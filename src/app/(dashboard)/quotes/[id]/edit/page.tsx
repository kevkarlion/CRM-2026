...
export default function EditQuotePage() {
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6">
      <div>
        <h1 className="text-xl sm:text-2xl font-bold text-gray-900">Editar Cotización</h1>
        <p className="text-sm text-gray-500 mt-1">Actualiza los datos de la cotización</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div className="bg-white border border-gray-200 rounded-xl p-6 space-y-5">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">
              ID del cliente <span className="text-danger-500">*</span>
            </label>
            <input
              type="text"
              value={clientId}
        ...
        <div className="flex items-center gap-3">
          ...
          <button type="button" onClick={() => router.push(`/quotes/${id}`)}
