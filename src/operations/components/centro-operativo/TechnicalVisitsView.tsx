          ...
          <tbody>
            {sorted.map((visit, idx) => (
              ...
              >
                ...
                <td className="px-2 py-1.5 align-middle">
                  <span className="text-xs text-gray-900 dark:text-slate-100">{visit.title}</span>
                </td>
                <td className="px-2 py-1.5 align-middle">
                  <span className="text-xs text-gray-600 dark:text-slate-300">{visit.clientSnapshot?.name || '—'}</span>
                </td>
                <td className="px-2 py-1.5 align-middle">
                ...
                <td className="px-2 py-1.5 align-middle">
                  <span className="text-xs text-gray-600 dark:text-slate-300">{visit.technicianName || 'Sin asignar'}</span>
                </td>
                <td className="px-2 py-1.5 align-middle">
                  {(() => {
